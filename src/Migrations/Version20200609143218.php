 ...
 */
final class Version20200609143218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evaluation (id INT AUTO_INCREMENT NOT NULL, training_id INT NOT NULL, company_id INT NOT NULL, eval_score_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, global_score INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_1323A575BEFD98D1 (training_id), INDEX IDX_1323A575979B1AD6 (company_id), INDEX IDX_1323A575577CFD42 (eval_score_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, is_archived TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, connection_number INT NOT NULL, INDEX IDX_D044D5D4979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participant_response (participant_id INT NOT NULL, response_id INT NOT NULL, INDEX IDX_303A8E069D1C3019 (participant_id), INDEX IDX_303A8E06FBF32840 (response_id), PRIMARY KEY(participant_id, response_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE certificate (id INT AUTO_INCREMENT NOT NULL, participant_id INT NOT NULL, session_id INT NOT NULL, company_id INT NOT NULL, training_id INT NOT NULL, attestation VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_219CDA4A9D1C3019 (participant_id), INDEX IDX_219CDA4A613FECDF (session_id), INDEX IDX_219CDA4A979B1AD6 (company_id), INDEX IDX_219CDA4ABEFD98D1 (training_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE certificate ADD CONSTRAINT FK_219CDA4A9D1C3019 FOREIGN KEY (participant_id) REFERENCES participant (id)');
        $this->addSql('ALTER TABLE certificate ADD CONSTRAINT FK_219CDA4A613FECDF FOREIGN KEY (session_id) REFERENCES session (id)');
        $this->addSql('ALTER TABLE certificate ADD CONSTRAINT FK_219CDA4A979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id)');
        $this->addSql('ALTER TABLE certificate ADD CONSTRAINT FK_219CDA4ABEFD98D1 FOREIGN KEY (training_id) REFERENCES training (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_eval_yn DROP FOREIGN KEY FK_5C3FBB41456C5646');
        ...
        $this->addSql('ALTER TABLE certificate DROP FOREIGN KEY FK_219CDA4A979B1AD6');
        $this->addSql('ALTER TABLE participant DROP FOREIGN KEY FK_D79F6B11613FECDF');
        $this->addSql('ALTER TABLE certificate DROP FOREIGN KEY FK_219CDA4A613FECDF');
        $this->addSql('ALTER TABLE training DROP FOREIGN KEY FK_D5128A8F613FECDF');
        $this->addSql('ALTER TABLE participant_response DROP FOREIGN KEY FK_303A8E069D1C3019');
        $this->addSql('ALTER TABLE certificate DROP FOREIGN KEY FK_219CDA4A9D1C3019');
        $this->addSql('ALTER TABLE participant_response DROP FOREIGN KEY FK_303A8E06FBF32840');
        $this->addSql('ALTER TABLE evaluation_eval_yn DROP FOREIGN KEY FK_5C3FBB414C493F27');
        ...
        $this->addSql('ALTER TABLE certificate DROP FOREIGN KEY FK_219CDA4ABEFD98D1');
